...
//         `${TABLEAU_BACKEND_URL}/tableau/signin`,
//         {
//           method: "POST",
...
const TableauAuthModal = ({ isOpen, onSuccess, onCancel }: TableauAuthModalProps) => {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // ✅ ADDED LOGGING
      console.log("🔍 SIGNIN HTTP STATUS:", {
      ...
      console.log("🔍 SIGNIN RESPONSE:", {
        hasToken: !!signinData.api_token,
        tokenType: typeof signinData.api_token,
        tokenLength: signinData.api_token?.length,
        tokenValue: signinData.api_token,
        tokenPreview: signinData.api_token?.substring(0, 50),
        isEmpty: signinData.api_token === "",
        isNull: signinData.api_token === null,
        isUndefined: signinData.api_token === undefined,
      });
      ...
      // ✅ ADDED LOGGING - verify what actually landed in sessionStorage
      const saved = sessionStorage.getItem("tableau_api_token");
      console.log("✅ SAVED TO SESSION STORAGE:", {
        saved,
        savedLength: saved?.length,
        preview: saved?.substring(0, 50),
        matchesSignin: saved === signinData.api_token,
      });
      ...
      // ✅ ADDED LOGGING
      console.log("🔍 fetch_data HTTP STATUS:", {
